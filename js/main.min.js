...
var githubToken = "9a5289fb2465cabb54387399811f6e8e64c4aa31", jsonObjects = [], filteredObjects = [], deferreds = [], sortParam, filterParam, endpointUri;
...
function searchJSON(input) {
    ...
    filteredObjects = [];
    $.each(jsonObjects, function(i, item) {
        var project = item.projectTitle.toLowerCase(), description = item.projectDescription.toLowerCase();
...
$(document).ready(function() {
    ...
    $(function() {
        var words = [ "Give", "Take", "Solve" ], index = 0, $el = $("#rotate-word");
